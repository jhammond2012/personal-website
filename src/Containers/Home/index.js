...
function Home() {
  return (
    <>
      <Header />
      <div className='container mx-auto flex justify-between items-center py-10 flex-col lg:flex-row px-10 lg:px-0'>
        <div className='w-full lg:w-9/12 mr-10'>
          <h1 className='text-7xl font-black leading-[80px] tracking-wide mb-8'>Hi! My name is<br />Jonathon</h1>
